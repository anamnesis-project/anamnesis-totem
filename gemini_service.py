...
9.  **Convert height:** If the user provides height in meters, convert to centimeters (e.g. "one point seven five" to "175").
10. **Convert sex:** Return 'M' or 'F'. If unsure, return 'N/A'.
